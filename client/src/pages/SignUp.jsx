...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen mt-20">
      <div
        className="flex p-3 max-w-2xl 
        mx-auto flex-col md:flex-row 
      ...
      >
        ...
        {/* right */}
        <div className="flex-1">
          <form className="felx flex-col gap-4" onSubmit={handleSubmit}>
            <div>
            ...
            <Button
             ...
             from-red-200
              via-red-300
               to-yellow-200
                text-gray-900 hover:bg-gradient-to-bl
                 focus:ring-red-100
                  dark:focus:ring-red-400 w-80
                  mt-3.5 text-2xl"
              type="submit"
              disabled={loading}
            >
